...
//
//    /**
//     * A {@link FollowService} implementation that can be used to get the values
...
//     * observer.
//     */
//    private class FollowServiceObserver implements SimplePageObserver<User> {
//
...
////        followServiceSpy.LoadMoreFollowing(currentAuthToken, currentUser, 3, null, observer);
//        followServiceSpy.LoadMoreFollowing(currentUser, 3, null, observer);
//        awaitCountDownLatch();
//
